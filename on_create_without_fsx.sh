...
PROVISIONING_PARAMETERS_PATH="provisioning_parameters_without_fsx.json"
...
logger "Running lifecycle_script_without_fsx.py with resourceConfig: $SAGEMAKER_RESOURCE_CONFIG_PATH, provisioning_parameters: $PROVISIONING_PARAMETERS_PATH"

python3 -u lifecycle_script_without_fsx.py \
